...
class Vintrica_Checkout {
	...
	/**
	 * Process a full checkout submission.
	 *
	...
	public function process_submission( array $post_data ) {
		...
		$stripe_session = $this->stripe->prepare_checkout_session( $order, $totals );
		...
		/**
		 * Fires after a VINTRICA order is stored and Stripe payload is prepared.
		 *
		 * @param object $order          Order row.
		 * @param array  $stripe_session Stripe session preparation result.
		 */
